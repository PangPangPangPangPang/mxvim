...
M.map = function()
	...
	map("n", "<F6>", ":lua require('config._vim_floaterm').open_bottom_term()<CR>", { silent = true })
	map("t", "<F6>", "<C-\\><C-n>:lua require('config._vim_floaterm').open_bottom_term()<CR>", { silent = true })
