...
M.set_keymap = function(client, bufnr)
	...
	buf_set_keymap("n", "<space>c[", "<cmd>lua vim.diagnostic.goto_prev({enable_popup=false})<CR>", opts)
	buf_set_keymap("n", "<space>c]", "<cmd>lua vim.diagnostic.goto_next({enable_popup=false})<CR>", opts)
