...
-- melange monokai tokyonight oxocarbon bamboo modus citruszest newpaper flexoki
...
mxvim.ignore_list = { "qf", "fugitive", "git", "Trouble", "noice", "fugitiveblame", "NeogitStatus", "help", "trouble" }
