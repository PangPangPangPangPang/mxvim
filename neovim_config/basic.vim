...
augroup BasicGroup
    ...
    autocmd FileType javascriptreact,javascript,html,css,xml,dart,json,swift set shiftwidth=2
    autocmd FileType javascriptreact,javascript,html,css,xml,dart,json,swift set tabstop=2
    autocmd FileType javascriptreact,javascript,html,css,xml,dart,json,swift set sts=2
