...
require('packer').startup({function(use)
    ...
    use {'nvim-telescope/telescope.nvim', requires = {'nvim-lua/popup.nvim', 'nvim-lua/plenary.nvim'}, config = function() require('telescope_config').config() end, cmd = {'Telescope'}}
